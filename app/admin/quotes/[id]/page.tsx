    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '20px' }}>
      <div style={{ marginBottom: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button className="btn btn-secondary no-print" onClick={() => router.push('/admin/quotes')}>
            ← Back to Quotes
          </button>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: 24, marginBottom: 20 }}>
        ...
        <div className="form-actions" style={{ borderTop: '1px solid var(--border)', paddingTop: 18, justifyContent: 'flex-end', gap: 10 }}>
          <button type="button" className="btn btn-secondary" onClick={() => router.push('/admin/quotes')}>
            Back to Quotes
          </button>
        </div>
      </div>
